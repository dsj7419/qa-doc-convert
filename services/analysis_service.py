...
class AnalysisService:
    ...
    @staticmethod
    def analyze_paragraphs(raw_paragraphs: List[str], status_callback) -> Tuple[Set[int], int]:
        """
        ...
        question_indices, est_count = AnalysisService._get_initial_question_indices(raw_paragraphs, status_callback)
        
        return question_indices, est_count
    
    @staticmethod
    def _get_initial_question_indices(paragraphs: List[str], status_callback) -> Tuple[Set[int], int]:
        """
        ...
        estimated_count = AnalysisService._estimate_question_count(paragraphs, status_callback)
    ...
    @staticmethod
    def _estimate_question_count(paragraphs: List[str], status_callback) -> int:
        """
